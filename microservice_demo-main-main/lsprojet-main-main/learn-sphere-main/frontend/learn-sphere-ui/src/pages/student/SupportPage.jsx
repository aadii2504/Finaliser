...
export default function SupportPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-80px)]">
      ...
      <main className="flex-1 w-full p-6 md:p-12 overflow-y-auto bg-black text-white">
        <div className="max-w-3xl mx-auto">
          <div className="mb-10 text-center md:text-left">
            <div className="w-16 h-16 rounded-2xl bg-indigo-500/10 flex items-center justify-center text-3xl mb-6 shadow-[0_0_30px_rgba(99,102,241,0.2)] ring-1 ring-indigo-500/30 mx-auto md:mx-0">
              💬
            </div>
